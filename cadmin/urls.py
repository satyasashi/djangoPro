...
urlpatterns = [
	...
	# password change and password change done are predefined views to change password
	# By default, it uses templates for both views. Let's add our own templates.
	url(r'^password-change-done', auth_views.password_change_done,
		{'template_name': 'cadmin/password_change_done.html'}, name="password_change_done"),
